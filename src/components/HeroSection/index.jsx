        ...
        <section className={classNames({
          ...
          <div className={classNames({
            ...
            <h1 className={classNames({
              ...
              'hero-section-sm:text-center hero-section-sm:flex-col hero-section-sm:gap-2 hero-section-sm:text-gray-200' : true,
          ...
          {/* Subtitle */}
          <p className={"mobile:!w-screen mobile:!text-center mobile:px-10 z-10 hero-section-sm:text-gray-200 hero-section:text-[1rem] hero-section:w-[17.5rem] text-lg lg:text-xl font-semibold w-fit"}>{"A centralized Portal for Sharing Resources"}</p>
          {/* Searchbar */}
          <div className={classNames({
