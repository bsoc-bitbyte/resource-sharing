  ...
  return (
    <footer class={classNames({
      ...
      "flex flex-col items-center justify-center gap-6": true,
        ...
        <div class="flex flex-col items-center justify-center w-[95vw] gap-6 relative">
          <strong
          ...
          <form class="w-screen grid place-items-center">
            <div class="relative w-[95vw] sm:w-[27.75rem]">
              <label class="sr-only" for="email"> Email </label>

              <input
                class="w-full rounded-full border-gray-200 bg-gray-100 p-4 text-sm font-medium"
                id="email"
                type="email"
