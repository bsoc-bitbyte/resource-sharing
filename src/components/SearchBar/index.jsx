...
const SearchBar = () => {
  return (
    <div className='flex items-center justify-center flex-col'>
     <div className='w-[90vw] bg-[#F3F4F6] flex items-center justify-center m-5 shadow-[3.33333px_4px_11.3333px_rgba(26,26,28,0.25)] rounded-2xl max-md:flex-col'>
        <div className='m-5 p-2 flex items-center justify-left w-[60vw] bg-white rounded-2xl max-md:w-[80vw]'>
          <img className='w-7' src="../src/assets/search.svg" alt="" />
          <input type="text" placeholder='Search' className='m-2 w-full'/>
        </div>
        <div className='flex w-[30vw] items-center justify-end max-md:w-full pr-7'>
