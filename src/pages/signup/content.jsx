      ...
      <div className="bg-white rounded-lg shadow-lg w-96 border-double border-4 border-sky-500 border-teal-100" >
        ...
        <form className="px-6 py-4">
          ...
          <div className="mb-6">
            ...
            <input type="email" className="w-full border-b-2 border-gray-300 focus:border-blue-500 outline-none dark:text-[#1A1A1C]" required onChange={(e) => setEmailid(e.target.value)}/>
          </div>
          <div className="mb-6">
          ...
          <div className="mb-6">
            ...
            <input type="password" className="w-full border-b-2 border-gray-300 focus:border-blue-500 outline-none dark:text-[#1A1A1C]" required onChange={(e) => setConfirmPassword(e.target.value)}/>
          </div>
          ...
          <div className={`mt-6 text-center text-base text-gray-600 ${(errorr)? 'visible' : 'hidden'}`}>
              {(errorr) ? errorr : null}
            </div>
